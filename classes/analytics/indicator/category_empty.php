 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class category_empty extends \core_analytics\local\indicator\binary {
    ...
    public static function get_name(): \lang_string {
        return new \lang_string('emptycat', 'local_testanalytics');
    }
    ...
    public function calculate_sample($sampleid, $sampleorigin, $notusedstarttime = false, $notusedendtime = false) {
        ...
        $courses = $DB->get_records('course', array('category' => $sampleid));
        if (empty($courses)) {
            return 1;
        }
        return -1;
