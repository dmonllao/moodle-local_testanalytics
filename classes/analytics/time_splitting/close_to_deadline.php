...
namespace local_testanalytics\analytics\time_splitting;
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class close_to_deadline extends \core_analytics\local\time_splitting\base {

    public static function get_name() : \lang_string {
        return new \lang_string('timesplitting:closetodeadline', 'local_testanalytics');
    }
    ...
    public function is_valid_analysable(\core_analytics\analysable $analysable) {
        ...
        if ($analysable->get_end() - $analysable->get_start() < (WEEKSECS + 1)) {
    ...
    protected function define_ranges() {
        ...
        $ranges = array(
            array(
                ...
                'end' => $this->analysable->get_end() - (4 * DAYSECS),
                'time' => $this->analysable->get_end() - (4 * DAYSECS),
            ), array(
                'start' => $analysablestart,
