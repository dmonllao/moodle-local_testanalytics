...
class assign implements \core_analytics\analysable {
    ...
    public function get_start() {
        ...
        if ($this->instance->allowsubmissionsfromdate) {
            return $this->instance->allowsubmissionsfromdate;
        }

        // Fallback to course but returns 0 if there is no course start date.
        return $this->get_cm_info()->get_course()->startdate;
    }
